...
export default function LINMAS() {
  ...
  // State utama
  const [tentang, setTentang] = useState('LINMAS adalah Perlindungan Masyarakat yang berperan dalam menjaga keamanan dan ketertiban di desa.');
  const [visi, setVisi] = useState('Menjadi garda terdepan dalam perlindungan masyarakat dan penanggulangan bencana di desa.');
  const [misi, setMisi] = useState([
    'Meningkatkan kesiapsiagaan masyarakat terhadap bencana dan gangguan keamanan.',
    'Mendorong partisipasi aktif warga dalam menjaga ketertiban.',
    'Membangun sinergi dengan aparat keamanan dan lembaga desa lainnya.'
  ]);
    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg text-white">LINMAS</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2 text-white">LINMAS adalah Perlindungan Masyarakat yang berperan dalam menjaga keamanan dan ketertiban di desa.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10 relative">
        ...
        {editMode ? (
          <div className="space-y-8 pt-8">
            <div>
              <div className="font-bold text-primary mb-2">TENTANG LINMAS</div>
              <textarea
                value={tentangEdit}
