  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div id="statistik-hero" className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center justify-center text-center px-4" style={{
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold drop-shadow-lg mb-3 tracking-tight">Statistik Desa Sidomulyo</h1>
        <div className="max-w-2xl mx-auto text-lg md:text-xl font-medium mb-4">Gambaran data kependudukan, pendidikan, pekerjaan, dan kehidupan sosial masyarakat Desa Sidomulyo secara visual dan informatif.</div>
