...
export default function Babinsa() {
  ...
  // State utama
  const [tentang, setTentang] = useState('BABINSA adalah Bintara Pembina Desa yang membina pertahanan dan keamanan di desa.');
  const [visi, setVisi] = useState('Menjadi pelindung dan pembina masyarakat desa dalam bidang pertahanan dan keamanan.');
  const [misi, setMisi] = useState([
    'Meningkatkan kesadaran bela negara di masyarakat.',
    'Membangun kemitraan dengan warga dalam menjaga keamanan.',
    'Mendukung ketahanan dan kemandirian desa.'
  ]);
    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg text-white">BABINSA</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2 text-white">BABINSA adalah Bintara Pembina Desa yang membina pertahanan dan keamanan di desa.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10 relative">
        ...
        {editMode ? (
          <div className="space-y-8 pt-8">
            <div>
              <div className="font-bold text-primary mb-2">TENTANG BABINSA</div>
              <textarea
                value={tentangEdit}
