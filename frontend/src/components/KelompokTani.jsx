...
export default function KelompokTani() {
  ...
  // State utama
  const [tentang, setTentang] = useState('Kelompok Tani adalah organisasi petani di desa yang bertujuan meningkatkan produktivitas pertanian dan kesejahteraan anggotanya.');
  const [visi, setVisi] = useState('Menjadi kelompok tani yang maju, mandiri, dan sejahtera.');
  const [misi, setMisi] = useState([
    'Meningkatkan pengetahuan dan keterampilan petani.',
    'Mengembangkan inovasi dan teknologi pertanian.',
    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg text-white">Kelompok Tani</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2 text-white">Kelompok Tani adalah organisasi petani di desa untuk meningkatkan produktivitas dan kesejahteraan.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10 relative">
        ...
        {editMode ? (
          <div className="space-y-8 pt-8">
            <div>
              <div className="font-bold text-primary mb-2">TENTANG KELOMPOK TANI</div>
              <textarea
                value={tentangEdit}
