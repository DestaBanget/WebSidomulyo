...
export default function KarangTaruna() {
  ...
  // State utama
  const [tentang, setTentang] = useState('Karang Taruna bertujuan mengembangkan potensi generasi muda dan meningkatkan kesejahteraan sosial masyarakat desa.');
  const [visi, setVisi] = useState('Menjadi organisasi kepemudaan yang kreatif, inovatif, dan berdaya saing.');
  const [misi, setMisi] = useState([
    'Mengembangkan potensi dan kreativitas pemuda desa.',
    'Mendorong partisipasi aktif pemuda dalam pembangunan desa.',
    'Meningkatkan kepedulian sosial dan solidaritas antar pemuda.'
  ]);
