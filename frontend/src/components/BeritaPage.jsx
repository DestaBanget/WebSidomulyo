...
export default function BeritaPage() {
  ...
  const heroImg = images.publikasi.berita;
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full py-10 md:py-20">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">Berita</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-2xl font-medium drop-shadow mb-4 md:mb-8">Dapatkan berita terkini seputar kehidupan dan perkembangan desa kami.</p>
          <input
            type="text"
