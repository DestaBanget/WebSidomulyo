  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="relative w-full h-[320px] md:h-[380px] flex items-center justify-center bg-primary/80">
        <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=1200&q=80" alt="Berita" className="absolute inset-0 w-full h-full object-cover object-center opacity-60" />
