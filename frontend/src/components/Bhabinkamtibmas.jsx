...
export default function Bhabinkamtibmas() {
  // Ganti heroImg dengan images.lembaga.bhabinkamtibmas
  const heroImg = images.lembaga.bhabinkamtibmas;
  ...
  // Fetch BHABINKAMTIBMAS data from backend
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const lembagaData = (data.lembaga || []).find(l => l.nama_lembaga && l.nama_lembaga.toLowerCase() === 'bhabinkamtibmas');
        if (!lembagaData) throw new Error('Data BHABINKAMTIBMAS tidak ditemukan di server');
        ...
        setError(err.message || 'Gagal mengambil data BHABINKAMTIBMAS');
      } finally {
        setLoading(false);
      }
    };
  ...
  if (!lembaga) return <div className="text-center py-20 text-red-600">Data BHABINKAMTIBMAS tidak ditemukan</div>;
    ...
    <div className="min-h-screen bg-white pb-10">
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full py-10 md:py-20">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">BHABINKAMTIBMAS</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-2xl font-medium drop-shadow mb-4 md:mb-8">Bhayangkara Pembina Keamanan dan Ketertiban Masyarakat</p>
        </div>
      </div>
      {/* Content Section */}
          ...
          {editMode ? (
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-primary">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Tulis tentang BHABINKAMTIBMAS di sini..."
                />
              </div>
              {/* Visi Section */}
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-500">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Tulis visi BHABINKAMTIBMAS di sini..."
                />
              </div>
              {/* Misi Section */}
                          ...
                          <div className="w-full text-center">
                            ...
                            {isAdmin && (
                              <button
                                ...
                                className="mt-2 px-3 py-1 bg-teal-500 text-white text-xs rounded-lg hover:bg-teal-600 transition-colors"
                              >
                                Edit
                              </button>
                            )}
            ...
            <>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-primary mb-8">
                <div className="font-bold text-primary text-lg mb-3">TENTANG BHABINKAMTIBMAS</div>
