...
export default function Bhabinkamtibmas() {
  ...
  // State utama
  const [tentang, setTentang] = useState('BHABINKAMTIBMAS adalah Bhayangkara Pembina Keamanan dan Ketertiban Masyarakat yang membina keamanan dan ketertiban di desa.');
  const [visi, setVisi] = useState('Menjadi mitra masyarakat dalam menciptakan lingkungan desa yang aman dan kondusif.');
  const [misi, setMisi] = useState([
    'Meningkatkan kesadaran hukum dan keamanan di masyarakat.',
    'Membangun komunikasi yang baik antara polisi dan warga.',
    'Mencegah terjadinya tindak kriminalitas di desa.'
  ]);
    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg text-white">BHABINKAMTIBMAS</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2 text-white">BHABINKAMTIBMAS adalah Bhayangkara Pembina Keamanan dan Ketertiban Masyarakat yang membina keamanan dan ketertiban di desa.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10 relative">
        ...
        {editMode ? (
          <div className="space-y-8 pt-8">
            <div>
              <div className="font-bold text-primary mb-2">TENTANG BHABINKAMTIBMAS</div>
              <textarea
                value={tentangEdit}
