    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full flex items-center justify-center text-white px-4 text-center min-h-[320px] md:min-h-[420px]" style={{background:'linear-gradient(180deg, rgba(30,64,175,0.85) 0%, rgba(30,64,175,0.0) 100%)'}}>
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full py-20">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg">PKK</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2">Pemberdayaan Kesejahteraan Keluarga (PKK) adalah gerakan nasional dalam pembangunan masyarakat yang tumbuh dari bawah.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10">
        <div className="font-bold text-primary mb-2">TENTANG PKK</div>
        <div className="text-gray-700 mb-6">PKK bertujuan memberdayakan keluarga untuk meningkatkan kesejahteraan masyarakat desa.</div>
        <div className="font-bold text-primary mb-2">VISI</div>
        <div className="text-gray-700 mb-6">Menjadi pelopor pemberdayaan keluarga dan masyarakat desa.</div>
        <div className="font-bold text-primary mb-2">MISI</div>
        <ol className="list-decimal ml-6 text-gray-700 mb-6">
          <li>Meningkatkan peran serta keluarga dalam pembangunan desa.</li>
          <li>Mendorong kemandirian dan kesejahteraan keluarga.</li>
          <li>Mengembangkan program-program PKK yang inovatif.</li>
        </ol>
