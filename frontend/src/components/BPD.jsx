  ...
  useEffect(() => {
    const fetchBPD = async () => {
      ...
      try {
        ...
        setLembaga(bpd);
        setTentangEdit(bpd.tentang || '');
        setVisiEdit(bpd.visi || '');
        setMisiEdit(bpd.misi || '');
        setPengurusEdit(bpd.pengurus || []);
        setUnitEdit(bpd.unit_kegiatan || []);
      } catch (err) {
    ...
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-2 drop-shadow-lg text-white">BPD</h1>
          <p className="text-lg md:text-xl font-medium text-white/90 drop-shadow-md mb-4">Badan Permusyawaratan Desa</p>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-primary">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Tulis tentang BPD di sini..."
                />
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-500">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Tulis visi BPD di sini..."
                />
              </div>
