...
export default function Poskesdes() {
  ...
  // State utama
  const [tentang, setTentang] = useState('Poskesdes (Pos Kesehatan Desa) adalah fasilitas pelayanan kesehatan tingkat desa yang memberikan pelayanan kesehatan dasar bagi masyarakat.');
  const [visi, setVisi] = useState('Menjadi pusat pelayanan kesehatan masyarakat desa yang profesional dan terjangkau.');
  const [misi, setMisi] = useState([
    'Meningkatkan akses dan mutu pelayanan kesehatan di desa.',
    'Mendorong perilaku hidup bersih dan sehat.',
    'Mendukung program kesehatan pemerintah di tingkat desa.'
  ]);
    ...
    <div className="min-h-screen bg-white pb-10">
      <div className="relative w-full min-h-[400px] md:min-h-[500px] flex flex-col items-center text-center px-4 pt-32 md:pt-40 pb-12 md:pb-20 overflow-hidden" style={{background: `url(${heroImg}) center/cover no-repeat`, borderRadius: '0 0 2.5rem 2.5rem'}}>
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg text-white">Poskesdes</h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium drop-shadow mb-2 text-white">Pos Kesehatan Desa (Poskesdes) adalah fasilitas kesehatan tingkat desa.</p>
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-10 relative">
        ...
        {editMode ? (
          <div className="space-y-8 pt-8">
            <div>
              <div className="font-bold text-primary mb-2">TENTANG POSKESDES</div>
              <textarea
                value={tentangEdit}
