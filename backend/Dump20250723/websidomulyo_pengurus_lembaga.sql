...
CREATE TABLE `pengurus_lembaga` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pengurus_lembaga_id` (`lembaga_id`),
  KEY `idx_pengurus_status` (`status`),
  CONSTRAINT `pengurus_lembaga_ibfk_1` FOREIGN KEY (`lembaga_id`) REFERENCES `lembaga_desa` (`id`) ON DELETE CASCADE
...
INSERT INTO `pengurus_lembaga` VALUES (1,1,'adwa','adw',NULL,NULL,NULL,0,'Aktif','2025-07-23 12:00:02','2025-07-23 12:00:02');
